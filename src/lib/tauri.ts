...
// ── Sites ──────────────────────────────────────────────────────────────────
export const addSite = (name: string, url: string, username: string, app_password: string) =>
  invoke<Site>('add_site', { name, url, username, appPassword: app_password });

export const testSiteConnection = (url: string, username: string, app_password: string) =>
  invoke<boolean>('test_site_connection', { url, username, appPassword: app_password });

export const listSites = () => invoke<Site[]>('list_sites');

export const updateSite = (id: string, name: string, url: string, username: string, app_password: string) =>
  invoke<Site>('update_site', { id, name, url, username, appPassword: app_password });

export const deleteSite = (id: string) => invoke<void>('delete_site', { id });

export const getPostTypes = (siteId: string) => invoke<PostType[]>('get_post_types', { siteId });

export const getCategories = (siteId: string) => invoke<WPTerm[]>('get_categories', { siteId });

export const getTags = (siteId: string) => invoke<WPTerm[]>('get_tags', { siteId });
...
export const getTask = (id: string) => invoke<TaskWithPosts>('get_task', { id });
